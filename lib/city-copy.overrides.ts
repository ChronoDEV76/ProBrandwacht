...
export const cityCopyOverrides: Partial<Record<CitySlug, Partial<CityCopy>>> = {
  amsterdam: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Amsterdam. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Amsterdam op moeten letten
...
- Toezicht tijdens tijdelijke afsluitingen, nachtwerk en ombouwmomenten`,
    ...
    localCaseBody:
      'Een opdrachtgever had kortdurend toezicht nodig bij een evenement op het NDSM-terrein. Er werd gewerkt met een kleine ploeg die het terrein goed kende. Er waren duidelijke afspraken over op- en afbouw, publiekstijden en nazorg. Eén aanspreekpunt en dezelfde gezichten hielpen de uitvoering uitlegbaar te houden.',
  },
  ...
  rotterdam: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Rotterdam. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Rotterdam op moeten letten
...
- Extra toezicht bij evenementen, scheepsbezoeken en publieksactiviteiten`,
    ...
    localCaseBody:
      'Voor een onderhoudsperiode in de haven werkte een opdrachtgever met meerdere brandwachten die gewend zijn aan industriële procedures. Er draaide een klein team in shifts. Afspraken over taken, rapportage en bereikbaarheid buiten kantoortijden lagen vooraf vast. Met directe lijnen en een vast aanspreekpunt.',
  },
  ...
  'den-haag': {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Den Haag. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Den Haag op moeten letten
...
- Toezicht bij tijdelijke installaties en evenementenstructuren`,
  ...
  utrecht: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Utrecht. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Utrecht op moeten letten
...
- Extra inzet bij logistieke hubs en distributielocaties`,
    ...
    localCaseBody:
      'Voor een tijdelijk evenement in de Utrechtse binnenstad werkte men met een brandwacht die ervaring had met zowel opbouw- als publieksuren. Afgesproken is wie het aanspreekpunt was voor de gemeente en de organisatie. Ook is vastgelegd welke checks er voor aanvang gedaan werden en hoe bevindingen werden teruggekoppeld.',
  },
  ...
  eindhoven: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Eindhoven. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Eindhoven op moeten letten
...
- Industriële inzet bij onderhoud, heetwerk en tijdelijke stops`,
    ...
    localCaseBody:
      'Een organisator in Eindhoven werkte met een brandwacht die zowel met publiek als techniek uit de voeten kon. Er was ervaring in evenementen en basiskennis van technische installaties. De taken waren vooraf duidelijk afgestemd.',
  },
  ...
  tilburg: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Tilburg. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Tilburg op moeten letten
...
- Extra toezicht bij logistieke hubs`,
    ...
    localCaseBody:
      'Bij een festivalperiode in Tilburg werkte de organisatie met een kleine, vaste ploeg brandwachten. Het team was meerdere dagen aanwezig, met vaste tijden en duidelijke taken. Eén aanspreekpunt hield contact met de organisatie.',
  },
  ...
  groningen: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Groningen. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Groningen op moeten letten
...
- Extra inzet bij tijdelijke installaties en onderhoud`,
  ...
  almere: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Almere. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Almere op moeten letten
...
- Extra toezicht bij tijdelijke installaties`,
  ...
  breda: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Breda. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Breda op moeten letten
...
- Extra inzet bij logistieke locaties`,
    ...
    localCaseBody:
      'Tijdens een stadsfestival in Breda is een brandwacht ingezet voor toezicht en afstemming met de organisatie. Heldere taken en communicatielijnen voorkwamen ruis tijdens piekuren.',
  },
  ...
  nijmegen: {
    ...
    metaDescription:
      'Onafhankelijke uitleg over brandwacht-inzet in Nijmegen. Wat is vereist, wie is verantwoordelijk en waar ligt de aandacht in de praktijk?',
...
## Waar opdrachtgevers in Nijmegen op moeten letten
