            ...
            {events
              ...
              .map((event, index) => (
                <tr key={index} className="odd:bg-white even:bg-slate-50">
                  ...
                  <td className="border-b p-2">{event.platform}</td>
                  <td className="border-b p-2">
                    <a className="max-w-[0] overflow-hidden text-ellipsis underline" href={event.url} target="_blank" rel="noopener noreferrer">
                      {event.url}
                    </a>
                  </td>
                </tr>
