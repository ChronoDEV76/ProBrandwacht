        ...
        <div className="mx-auto max-w-5xl px-4 py-12 md:py-16">
          ...
          <p className="mt-3 max-w-2xl text-sm text-slate-200">
            ...
            <p className="text-xs text-slate-400 md:text-sm">
              Deze spoed-funnel is een vroege voorloper van de directe
              opdrachtmatching in ProSafetyMatch. Door nu al je aanvragen via dit
              kanaal te doen, help je ons de markt slimmer en eerlijker in te
              richten.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <ol className="space-y-4 text-sm text-slate-200 md:text-base">
                ...
                <li>
                  ...
                  <br />
                  De manier waarop jouw spoedaanvraag verloopt, gebruiken we als
                  input om ProSafetyMatch verder te ontwikkelen tot een breed
