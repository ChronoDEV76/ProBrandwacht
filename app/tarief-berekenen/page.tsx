...
const calculatorFaq = [
  {
    ...
    answer:
      'Nee. De calculator geeft een indicatie op basis van jouw input. Het uiteindelijke tarief spreek je altijd 1-op-1 af met de opdrachtgever en is afhankelijk van context, risico en certificering.',
  },
  {
